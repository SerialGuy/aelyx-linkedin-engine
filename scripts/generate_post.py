...
Technical rules:
- Use inline fill/stroke/font attributes on elements. Do NOT use <style> blocks or CDATA.
- Keep all text inside the 1200x1200 canvas — no clipped or overflowing copy.
- Use simple shapes and clear hierarchy. Avoid complex paths that break at corners."""
